---
title: "Agents Can Build. What Is Left to Learn?"
description: "Why the desire to learn, teach, and create matters even more when agents can produce software for us."
published: 2026-07-30T23:23:34-07:00
draft: false
---
...
- [Ghostty](https://ghostty.org/) as a path into terminal and native application infrastructure
...
- [llm.c](https://github.com/karpathy/llm.c) and [llama.cpp](https://github.com/ggml-org/llama.cpp) as paths into model training and inference
- [Pi](https://github.com/earendil-works/pi) as a path into a small, understandable agent loop
- [Omarchy](https://omarchy.org/) as an example of rethinking the computer around a newer generation of tools
